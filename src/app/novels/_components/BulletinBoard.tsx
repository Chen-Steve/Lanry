...
const BulletinBoard = () => {
  ...
  return (
    <div className="my-2 flex gap-2">
      ...
      <div 
        className="flex-1 p-4 rounded-lg border border-border shadow-sm flex flex-col items-center justify-center relative overflow-hidden"
        style={{
      ...
      >
        ...
        <a
          href="/forum"
          className="text-white font-medium hover:text-white/90 transition-colors relative z-10"
        >
          Visit Forum
        </a>
      </div>
